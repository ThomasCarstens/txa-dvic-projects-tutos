...
class SettingsService(object):
    ...
    def GetConfig(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/fkie_multimaster_msgs.settings.SettingsService/GetConfig',
            fkie__multimaster__msgs_dot_grpc_dot_settings__pb2.Filter.SerializeToString,
            fkie__multimaster__msgs_dot_grpc_dot_settings__pb2.Yaml.FromString,
    ...
    def SetConfig(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/fkie_multimaster_msgs.settings.SettingsService/SetConfig',
            fkie__multimaster__msgs_dot_grpc_dot_settings__pb2.Yaml.SerializeToString,
            fkie__multimaster__msgs_dot_grpc_dot_settings__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
