...
let my_newFeedback = require('./my_newFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class my_newActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new my_newFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = my_newFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new my_newActionFeedback(null);
    ...
    data.feedback = my_newFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new my_newActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = my_newFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new my_newFeedback()
    }
...
module.exports = my_newActionFeedback;
