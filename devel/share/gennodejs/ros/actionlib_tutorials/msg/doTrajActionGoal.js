...
class doTrajActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = doTrajGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new doTrajActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = doTrajGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new doTrajGoal()
    }
...
module.exports = doTrajActionGoal;
