...
class doTrajActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new doTrajFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = doTrajFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new doTrajActionFeedback(null);
    ...
    data.feedback = doTrajFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new doTrajActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = doTrajFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new doTrajFeedback()
    }
...
module.exports = doTrajActionFeedback;
