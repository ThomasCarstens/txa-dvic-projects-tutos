...
class doTrajActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = doTrajResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new doTrajActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = doTrajResult.Resolve(msg.result)
    }
    else {
      resolved.result = new doTrajResult()
    }
...
module.exports = doTrajActionResult;
