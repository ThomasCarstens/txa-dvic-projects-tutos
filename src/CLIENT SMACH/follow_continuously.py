...
def polygonial():
    ...
    with sm0:
        ...
        StateMachine.add('SPAWN',
                ...
                {'succeeded':'PREEMPTABLE_MOVE'+ str(0)})
        ...
        for i in range(10):
            ...
            StateMachine.add('PREEMPTABLE_MOVE' + str(i),
                    draw_monitor_cc,
                    {'aborted':'TELEPORT'+ str(i)})

            StateMachine.add('TELEPORT'+ str(i),
                    ServiceState('turtle2/teleport_absolute', turtlesim.srv.TeleportAbsolute,
                        request = turtlesim.srv.TeleportAbsoluteRequest(int(i+1), int(16-i),0.0)),
                    {'succeeded':'PREEMPTABLE_MOVE'+ str(i+1)})
...
#                        if not msg.data:
        ...
        StateMachine.add('PREEMPTABLE_MOVE' + str(10),
                    draw_monitor_cc,
                    {'aborted':'TELEPORT'+ str(0)})
