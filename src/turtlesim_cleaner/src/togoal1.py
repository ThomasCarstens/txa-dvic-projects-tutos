...
class FibonacciAction(object):
    ...
    def execute_cb(self, goal):
        ...
        while self.success == False:
            ...
            try:
                ...
                self.move2goal(goal.destination, turtle_pose)
                currentPose = int(turtle_pose.x)
    ...
    def steering_angle(self, goal_pose, my_pose):
        """See video: https://www.youtube.com/watch?v=Qh15Nol5htM."""
        return atan2(goal_pose.y - my_pose.y, goal_pose.x - my_pose.x)
    ...
    def move2goal(self, destination, my_pose):
        ...
        #print("debug: move tt2")
        while self.euclidean_distance(goal_point, my_pose) >= distance_tolerance:
            print("debug: approach tt2")
            #self.mutex.acquire()
            self.success = False
            ...
            if my_pose == self.turtle1_pose:
                self.velocity_publisher1.publish(vel_msg)
            if my_pose == self.turtle2_pose:
