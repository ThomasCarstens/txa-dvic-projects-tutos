...
class ArenaFlyer(object):
    ...
    def cf2_callback(self, cf2):
    	...
    	self.cf2_pose.pose.x = cf.transform.translation.x
    	self.cf2_pose.pose.y = cf.transform.translation.y
    	self.cf2_pose.pose.z = cf.transform.translation.z

	cf2_publisher.publish(self.cf2_pose)
