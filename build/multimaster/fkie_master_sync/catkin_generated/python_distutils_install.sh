...
echo_and_run cd "/home/thomas/cours-de-robotique/src/multimaster/fkie_master_sync"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/thomas/cours-de-robotique/build/multimaster/fkie_master_sync" \
    install \
    --root="${DESTDIR-/}" \
