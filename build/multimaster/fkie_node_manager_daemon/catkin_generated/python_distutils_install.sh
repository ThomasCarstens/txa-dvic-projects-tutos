...
echo_and_run cd "/home/thomas/cours-de-robotique/src/multimaster/fkie_node_manager_daemon"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/thomas/cours-de-robotique/build/multimaster/fkie_node_manager_daemon" \
    install \
    --root="${DESTDIR-/}" \
